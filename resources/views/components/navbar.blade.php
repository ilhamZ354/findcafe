<!-- ===== Header Start ===== -->
<header class="sticky top-0 w-full z-999 drop-shadow-1 dark:drop-shadow-none" style="background:#DDBC95;">
    <div class="flex items-center justify-between w-full px-2 py-2">
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            <!-- Hamburger Toggle BTN -->
            <button
                class="z-99999 block rounded-sm border border-stroke p-1.5 lg:hidden"
        ...
        <div class="hidden sm:flex items-center gap-4 w-full">
            ...
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('images/logo-cafe-hunt.png') }}" alt="Logo" width="150" />
            </a>

            <!-- Search Bar -->
            <form action="#" method="POST" class="flex-1 mr-5 text-black">
                <div class="relative max-w-xl mx-auto bg-white rounded-full">
                    <input type="text" placeholder="Search Cafe..."
                    class="w-full pl-12 pr-4 py-2 bg-transparent border border-black rounded-full focus:outline-none focus:border-white focus:ring-2 focus:ring-white" />
                </div>
            </form>
