...
<div>
    <label for="image_menu" class="block mb-2 text-sm font-medium text-gray-900">Gambar Menu</label>
    <div class="relative w-fit">
        <img src="{{ $value !== '' ? $value : asset('images/blank-image.jpg') }}" alt="image-menu-default"
            class="object-cover w-32 h-32 rounded-sm" id="image_menu_preview">
        <label for="image_menu_input"
