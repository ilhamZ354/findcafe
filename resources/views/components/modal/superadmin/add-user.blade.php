<x-modal.modal-template id_modal="add-user" title_modal="Tambah User">
    <!-- Modal body -->
    <form class="p-4 md:p-5" method="POST" action="{{ route('superadmin.user.store') }}">
        @csrf
        <div class="grid grid-cols-1 gap-4 mb-4">
            ...
            {{-- Nama User --}}
            <x-form.input-field name="username" value="{{ $username ?? '' }}" label="Nama User"
