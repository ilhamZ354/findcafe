        ...
        <div class="flex space-x-3 md:order-2 md:space-x-0 rtl:space-x-reverse">
            ...
            @else
                <div class="flex gap-2 justify-end items-center">
                    <a href="{{ route('login') }}"
                        class="text-white bg-primaryBrown hover:bg-semiPrimaryBrown font-medium rounded-lg text-sm px-5 py-1.5 me-2">Daftar</a>
                    <a href="{{ route('login') }}"
                        class="text-primaryBrown hover:text-white border border-primaryBrown hover:bg-primaryBrown focus:outline-none font-medium rounded-lg text-sm px-5 py-1.5 text-center me-2">Login</a>
                </div>
            @endif
