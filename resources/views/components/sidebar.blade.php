    <aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
        ...
        <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
            <a href="{{ route('dashboard') }}">
                <img src="{{ asset('images/logo-cafe-hunt.png') }}" alt="Logo" />
            </a>
            ...
            <nav class="px-4 py-4 mt-5 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
                ...
                <div>
                    ...
                    <ul class="mb-6 flex flex-col gap-1.5">
                        <!-- Menu Item Dashboard -->
                        <li>
                            <a class="group relative flex items-center gap-2.5 rounded-xl px-4 py-2 font-medium duration-300 ease-in-out"
