<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    class="absolute top-0 left-0 flex flex-col h-screen overflow-y-hidden duration-300 ease-linear bg-lightPrimaryBrown w-[70vw] md:w-[20vw] z-40 dark:bg-boxdark lg:static lg:translate-x-0"
    @click.outside="sidebarToggle = false">
    <!-- SIDEBAR HEADER -->
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="/">
            <img src="{{ asset('images/logo-cafe-hunt.png') }}" alt="Logo" loading="lazy" class="h-20" />
        </a>
